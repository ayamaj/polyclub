    ...
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-1 py-4">
            <div class="card-body" style="width: 700px; ">
                <form class="row g-0" action="{{ route('admin.admin.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::name-->
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" style="border: none" id="image" name="image" class="@error('name') is-invalid @enderror">
                        <br>
                        <div class="container_message">
                            @error('name')
                                <span style="color: red">{{ $message }}</span>
