...
@section('content')
                        ...
                        <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase">{{ $event->description }}</h4>
                                    <h2 class="display-1 text-white mb-md-4">{{ $event->titre }}</h2>
                                    <h4 class="text-white text-uppercase">{{ $event->date }}</h4>
                                </div>
                            </div>
                        </div>
                    @endforeach
                            ...
                            <div class="position-relative overflow-hidden">
                                <a href="{{ route('one_event', ['event' => $event->id]) }}">
                                    <img class="img-fluid" src="{{ asset($event->image) }}" alt="{{ $event->titre }}"
                                        ...
                                        style="width: 600px; height:200px; object-fit: cover;"> </a>
                            </div>
    ...
    {{-- end 3  event --}}
@endsection
{{-- message flash message 3 second --}}
<script>
...
{{--  end message flash message 3 second --}}
