                    ...
                    <div class="col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="bg-secondary d-flex">
                                ...
                                <div class="d-flex flex-column justify-content-center py-3 px-4">
                                    <div class="d-flex mb-2">
                                        <small class="text-uppercase me-1"><i class="bi bi-shop" style="margin-right: 7px;"></i>{{ $event->place }}</small>
                                        <small class="text-uppercase me-2"><i class="bi bi-calendar2-check" style="margin-right: 5px;"></i> {{ $event->duration }}</small>
